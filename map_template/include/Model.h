...
public:
	...
	{
		//выдать только те пути, которые соответсвуют зоне ответственности
		//запросить у базы данных по идентификатору пользователя из Auth выдать список регионов
		//найти регионы для путей, отсеять лишние регионы
